<template>
    <div :class="['scroll-bar__track', { 'is-vertical': type === 'vertical' }, { 'is-horizontal': type === 'horizontal' }]" @mousedown="handleClick">
        <div class="scroll-bar__thumb" :style="thumbStyle" @mousedown.stop="e => handleDrag(e)"></div>
    </div>
</template>
    ...
    methods: {
        ...
        handleDrag(e) {
            ...
            const handleDragStart = e => {
                ...
                const rate = type === "vertical" ? (clientY - y) / (track.height - thumb.height) : (clientX - x) / (track.width - thumb.width);
